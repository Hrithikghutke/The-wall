...
public class WallpapersAdapter extends RecyclerView.Adapter<WallpapersAdapter.WallpaperViewHolder> {
    ...
    class WallpaperViewHolder extends RecyclerView.ViewHolder
        ...
        private void setWallpaper(Wallpaper v){
            final WallpaperManager myWallpaperManager = WallpaperManager.getInstance(mCtx);
            ((Activity) mCtx).findViewById(R.id.spin_kit).setVisibility(View.VISIBLE);
            ...
            Glide.with(mCtx)
                    ...
                    .into(new CustomTarget<Bitmap>(width,height) {
                              ...
                              public void onResourceReady(Bitmap resource, Transition<? super Bitmap> transition) {
                                  ((Activity) mCtx).findViewById(R.id.spin_kit).setVisibility(View.GONE);
                    ...
                    .into(new CustomTarget<Bitmap>() {
                              ...
                              public void onResourceReady(Bitmap resource, Transition<? super Bitmap> transition) {
                                  ...
                                  if (uri != null) {
                                      ...
                                      Toast.makeText(mCtx, "Image is saved", Toast.LENGTH_SHORT).show();
